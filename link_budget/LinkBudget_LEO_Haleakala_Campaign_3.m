% LinkBudget_LEO_Haleakala_Campaign_3.m
%
...
% M = 16; DP-QPSK, dual 4 bits
% dr = r_s*log2(M)
dr = 100e9;                         % [bps], with headers
...
theta_tx_rad =600e-6;              % [rad], full-width half-max - FWHM

% Orbit altitude presets [m]: LUCE/OICETS=610e3, FLP=595e3, TBIRD=530e3
h_orbit = 370e3;                    % [m], TBIRD value

% --- Receiver (OGS) ---
% OGS altitude above MSL [m]: OP-OGS=578, GSOC-OGS=650
% NASA Haleakala - https://en.wikipedia.org/wiki/Haleakal%C4%81_Observatory
h_ogs = 3050;                        % [m]

% Primary aperture presets [m]: GSOC=0.3, Infra-FE4.41.0-17=2.5e-3, Infra-FE5.61.0-17=5.6e-3
% NASA Haleakala = 60cm - https://ntrs.nasa.gov/api/citations/20180001570/downloads/20180001570.pdf
d_rx_o = 0.6;                       % [m], TBIRD outer aperture
...
a_rx = -4.0;  % [dB], https://ntrs.nasa.gov/api/citations/20230007959/downloads/TBIRD-smallsat-2023.pdf

%% 4. Elevation grid
el_deg_report = 25;     % single elevation for tabular report
